  ...
  return (
    <aside className="flex flex-col gap-8 md:gap-10">
      <div className="bg-white/5 p-6 rounded-2xl border border-white/5 shadow-sm">
        <h4 className="font-black text-sm uppercase tracking-widest mb-4 flex items-center gap-2 text-white italic">
        ...
        <div className="flex flex-col gap-2">
            ...
            <button className="w-full bg-primary text-white rounded-xl py-2 text-xs font-black uppercase tracking-widest hover:bg-primary/80 transition-colors cursor-pointer italic">Inscrever</button>
        </div>
      </div>
      ...
      <div>
        <h4 className="font-black text-sm uppercase tracking-widest mb-6 flex items-center gap-2 text-white italic">
        ...
        <div className="flex flex-col gap-6">
            {[1, 2, 3, 4, 5].map(i => (
                <div key={i} className="flex gap-4 group cursor-pointer border-b border-white/5 pb-4 last:border-0 last:pb-0">
                    <span className="text-3xl font-black text-primary/20 group-hover:text-primary transition-colors leading-none italic">0{i}</span>
                    <p className="text-sm font-bold leading-tight group-hover:text-primary transition-colors line-clamp-2 uppercase italic text-white/80 tracking-tight">
